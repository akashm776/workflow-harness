...
from compiler.static_validation import validate_unknown_node_types
...
INVALID_FIXTURE = ROOT / "fixtures" / "invalid" / "unknown-node-type"


class UnknownNodeTypeValidationTests(unittest.TestCase):
    def test_valid_fixtures_pass_unknown_node_type_validation(self) -> None:
        for fixture_name in VALID_FIXTURES:
            fixture_input = ROOT / "fixtures" / "valid" / fixture_name / "input"
            result = validate_unknown_node_types(
    ...
    def test_invalid_fixture_fails_unknown_node_type_validation(self) -> None:
        expected = json.loads(
